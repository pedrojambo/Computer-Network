 ...
 * @author Daniel
 */
public class MsgBuscaSA extends Message{
    ...
    public MsgBuscaSA(SimpleNode Origem,int Destino,long T){
    ...
    public MsgBuscaSA(Rotas R,int Destino,long T){
        this.R=R;
        this.IDDestino=Destino;
        this.TempoInicio=T;
    }
    ...
    public Message clone() {
        MsgBuscaSA msg = new MsgBuscaSA(this.R,IDDestino,TempoInicio);
        return msg;
    }
