 ...
 * @author Daniel
 */
public class MsgBuscaSG extends Message{
    ...
    public MsgBuscaSG(SimpleNode Origem,int Destino,long T){
    ...
    public MsgBuscaSG(Rotas R,int Destino,long T){
        this.R=R;
        this.IDDestino=Destino;
        this.TempoInicio=T;
    }
    ...
    public Message clone() {
        MsgBuscaSG msg = new MsgBuscaSG(this.R,IDDestino,TempoInicio);
        return msg;
    }
