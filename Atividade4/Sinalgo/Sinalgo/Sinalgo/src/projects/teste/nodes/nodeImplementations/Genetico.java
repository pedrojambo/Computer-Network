...
public class Genetico {
    ...
    public Genetico(TabelaRotas População, int Gerações, double C_Mut, double C_Crz) {
        this.População = População;
        this.Gerações=Gerações;
        individuos=População.getsize();
    ...
    public double[] Evoluir(){
        //System.out.println("GA evolving");
        double v[] = new double[Gerações];
        int Lim=Gerações;
        int c=0,b=0;
        Random E=new Random();
        Rotas vetm[]=new Rotas[Lim];
